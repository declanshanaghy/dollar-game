...
- [x] UI Bugs
  - [x] Too many cash stacks are appearing on the animated lines, ensure only a negative 1 or positive 1 cash stack appears depending on whether the action is to give or receive.
  - [x] Add arrows at the end of the animated lines, ensure the animated lines don't cross over the buttons
  - [x] Make give/receive arrows use different paths
  - [x] Fix arrow head alignment
